            ...
            <div className="bg-white p-4 justify-between w-9/10 sm:w-7/10 md:w-1/3 mx-auto rounded shadow">
                ...
                {mailSent ? (
                    <div className="text-green-600 text-center font-semibold my-6">
                        ...
                        <span className="text-gray-500 text-sm">After verification, you can <button onClick={() => window.location.pathname = "/login"} className="text-blue-500 cursor-pointer">log in</button>.</span>
                        <br />
